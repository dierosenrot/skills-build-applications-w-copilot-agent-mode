...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # Create Workouts
        app_models.Workout.objects.create(name='Hero HIIT', description='High intensity workout for heroes', suggested_for=marvel)
        app_models.Workout.objects.create(name='Super Strength', description='Strength workout for super heroes', suggested_for=dc)
